...
function _execute(agent::MyTotalisticWolframRuleModel, frame::Array{Int64,2}, time::Int64)::Int64
...
function _solve(agents::Array{MyTotalisticWolframRuleModel,1}, world::MyOneDimensionalPeriodicGridWorld;
    initial::Array{Int,2} = Array{Int,2}(), steps::Int=100, verbose::Bool=false)::Dict{Int, Array{Int,2}}
